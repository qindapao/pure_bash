...
# Storage:~/qinqing # struct_dump_hq 'my_dict' >1.txt
# Storage:~/qinqing # declare -p my_my_dict >2.txt
# Storage:~/qinqing # source 2.txt 
# Storage:~/qinqing # declare -p my_dict
# declare -A my_dict=([last_key1]="declare -a _struct_set_field_chen_xu_yuan_yao_mo_hao_zhi_ji_de_dao_data_lev2=([0]=\"v0\" [1]=\"x1\" [2]=\"x2\" [3]=\"x3\" [4]=\"declare -A _struct_set_field_chen_xu_yuan_yao_mo_hao_zhi_ji_de_dao_data_lev3=([other_key]=\\\"other6\\\" [other_key2]=\\\"other2\\\" [other_key3]=\\\"declare -a _struct_set_field_chen_xu_yuan_yao_mo_hao_zhi_ji_de_dao_data_lev4=([0]=\\\\\\\"other3-0\\\\\\\" [1]=\\\\\\\"other3-1\\\\\\\" [2]=\\\\\\\"other3-2\\\\\\\" [3]=\\\\\\\"other3-3\\\\\\\")\\\" )\" [10]=\"v10\")" [last_key]="declare -A _struct_set_field_chen_xu_yuan_yao_mo_hao_zhi_ji_de_dao_data_lev2=([z4]=\"x4\" [z5]=\"x5\" [z2]=\"x2\" [z3]=\"x3\" [z1]=\"x1\" [xxx]=\"0\" [xxx2]=\"value2\" [xxx3]=\"value3\" )" )
# Storage:~/qinqing # . ./struct/struct_dump.sh
# Storage:~/qinqing # struct_dump_hq my_dict
# my_dict =>
#     last_key => 
#         xxx => 0
#         xxx2 => value2
...
# 另外_struct_set_field_chen_xu_yuan_yao_mo_hao_zhi_ji_de_dao_data_lev这个名字也具有一定的危险性,如果字符串本身就包含它?要用不常用的unicode字符组合来表示?或者把这个名字取得更长,减少冲突的可能性

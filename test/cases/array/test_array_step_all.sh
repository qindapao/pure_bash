...
_test_array_step_all_old_dir="$PWD"
root_dir="${PWD%%/pure_bash*}/pure_bash"

cd "$root_dir"/src
. ./log/log_dbg.sh || return 1
. ./date/date_log.sh || return 1
. ./array/array_step_all.sh || return 1

cd "$root_dir"/test/lib
. ./assert/assert_array.sh || return 1

cd "$_test_array_step_all_old_dir"
...
test_case1 ()
{
    ...
    local ret_str=''
    array_step_all a a1 0 1 a2 0 2 a3 1 2
    ...
    array_step_all b b1 0 3 b2 1 3 b3 2 3

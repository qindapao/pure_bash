...
_test_file_del_pattern_old_dir="$PWD"
root_dir="${_test_file_del_pattern_old_dir%%/pure_bash*}/pure_bash"
...
cd "$_test_file_del_pattern_old_dir"
...
test_case1 ()
{
    ...
    echo "         " >>"$tmp_file1"
    echo "         " >>"$tmp_file1"
    file_del_pattern "$tmp_file1" '^[[:space:]]*return[[:space:]]*0[[:space:]]*$' >"$tmp_file_result"
